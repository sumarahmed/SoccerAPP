...
Bundle version 2.0, Sep 14, 2026.
...
python build.py --output ../../../../../tmp/soccolo-brand-build/Soccolo-Brand-Bundle-v2
```
...
profiles. The two approved PDFs are copied byte-for-byte rather than recreated.
...
## Eight things worth knowing before you use any of it
