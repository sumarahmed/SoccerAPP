# Soccolo identity usage specification — Concept E v0.1

## Identity and status

- Working name: `Soccolo`.
- Working theme: `Train, Play, Grow`.
- Brand ID: `working-soccolo-e-v0.1`.
...
The wordmark and symbol are original repository geometry built from paths and circles. The double-`c` forms face the same direction and are separated by one touch point. This differs materially from the mirrored/interlocking generated Concept E board and is intended to communicate two controlled touches moving forward.
...
- represent v0.1 as a cleared, registered or approved launch asset.
