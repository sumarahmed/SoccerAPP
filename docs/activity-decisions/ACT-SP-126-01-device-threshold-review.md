# ACT-SP-126-01 — Device threshold review acceptance

| Field | Value |
|---|---|
| Activity | ACT-SP-126-01 |
| Source issue | SP-126 |
...
100 ms dual-source start-skew and ten-minute drift ceilings.

The owner reported access to an iPhone 16 Pro Max, iPhone 17 Pro, iPad Air and a
latest-model Samsung phone. Only the two iPhone marketing names are sufficiently
specific to retain as stated; exact model numbers remain pending. The iPad Air
generation and Samsung product/model are unresolved. OS/build, free storage,
