...
- [Current feature map](soccer_feature_traceability.md)
- [Current delivery backlog (165 source tasks after the 8 September planning update)](soccer_delivery_backlog.md)
- [Business and platform baseline](baseline/soccer_end_to_end_platform_and_business_plan.md)
- [Design baseline, including appearance](baseline/soccer_pilot_and_design_pack.md)
- [Administration baseline](baseline/soccer_club_parent_and_coach_administration.md)
- [Security gap baseline](baseline/soccer_end_to_end_security_and_gap_review.md)
