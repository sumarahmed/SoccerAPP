...
**Accepted decisions:** [SP-001 launch and account assumptions](docs/decisions/SP-001-launch-and-account-assumptions.md) version 1.0 was accepted by the founder/product owner on 10 September 2026. [SP-075 ownership and discovery authority](docs/decisions/SP-075-ownership-and-discovery-authority.md) and [SP-004 pilot metrics, budget and specialist scopes](docs/decisions/SP-004-pilot-metrics-budget-and-specialist-scopes.md) version 1.0 were accepted on 11 September 2026. Syed Ahmed holds all primary accountable roles for the one-person company; all human backups and independent reviewers are explicitly vacant, incremental discovery spend is capped at AUD 0, only Syed may contact specialists, and no discovery brief has been issued. Pre-research thresholds and a Windows-only development/owned-device access plan are fixed. The recorded vacancies and missing Mac build host block the sensitive or iOS actions that require real specialist, independent or macOS/Xcode evidence. These decisions do not claim participant recruitment, specialist approval, device-test results or implementation evidence.
...
Documentation synchronized 8 September 2026; the development foundation plan and attributable SP-001/SP-075/SP-004 decisions were added 10–11 September 2026. SP-001, SP-075 and SP-004 are accepted through their dated decision artifacts. SP-003's agent-scope and evidence-policy activities remain the next G0 control work before bounded implementation-agent runs; newly dependency-ready P01 preparation may proceed without treating deferred specialist evidence as complete. The frozen planning-package manifests still retain their original Backlog/Not started state, and foundation milestones remain proposed. No production application, live database, customer billing setup, live Linear import or autonomous agent dispatch is represented by this documentation update. Specialist review and implementation evidence remain required at the relevant downstream delivery gates.
